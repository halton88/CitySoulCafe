...
$cfg['email_address'] = 'mediacitysoul@gmail.com';
...
$cfg['form_name'] = 'CSC contact form';
...
$cfg['adminnotification_subject'] = '{Name*|8} Sent a message via the the City Soul Cafe Website';
...
$cfg['formvalidation_required'] = array('cfgen-element-1-8','cfgen-element-1-3');
