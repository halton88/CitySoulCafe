...
<div class="cfgen-e-c">
	<div class="cfgen-title" id="cfgen-element-1-1">Contact us</div>
</div>
...
<div class="cfgen-e-c">
	...
	<label class="cfgen-label" id="cfgen-element-1-8-label" ><span class="cfgen-label-value">Name</span><span class="cfgen-required">*</span></label>
	...
	<div class="cfgen-e-set" id="cfgen-element-1-8-set-c">
		<div class="cfgen-input-group" id="cfgen-element-1-8-inputgroup-c">
			<div class="cfgen-input-c" id="cfgen-element-1-8-input-c">
				<input type="text" class="cfgen-type-text cfgen-form-value " name="cfgen-element-1-8" id="cfgen-element-1-8">
			</div>
		</div>
	</div>
...
<div class="cfgen-e-c">
	...
	<label class="cfgen-label" id="cfgen-element-1-6-label" ><span class="cfgen-label-value"></span></label>

	<div class="cfgen-e-set" id="cfgen-element-1-6-set-c">
		<div class="cfgen-input-group" id="cfgen-element-1-6-inputgroup-c">
			<select class="cfgen-type-select cfgen-form-value " name="cfgen-element-1-6" id="cfgen-element-1-6">
				<option value="General Comment or Question"  selected="selected" >General Comment or Question</option>
				<option value="Vendor Request" >Vendor Request</option>
				<option value="Feature Artist Inquiry" >Feature Artist Inquiry</option>
			</select>
		</div>
	</div>
...
<div class="cfgen-e-c">
	...
	<label class="cfgen-label" id="cfgen-element-1-7-label" ><span class="cfgen-label-value">Captcha: Type the characters below</span></label>

	<div class="cfgen-e-set" id="cfgen-element-1-7-set-c">
		<div class="cfgen-captcha-c">
			<img src="cfgen-form-1/inc/captcha.php" class="cfgen-captcha-img" alt="" ><img src="cfgen-form-1/img/captcha-refresh.png" class="cfgen-captcha-refresh" alt="">
		</div>
		<div class="cfgen-input-group" id="cfgen-element-1-7-inputgroup-c">
			<div class="cfgen-input-c" id="cfgen-element-1-7-input-c">
				<input type="text" name="cfgen-element-1-7" id="cfgen-element-1-7" class="cfgen-captcha-input">
			</div>
		</div>
	</div>
